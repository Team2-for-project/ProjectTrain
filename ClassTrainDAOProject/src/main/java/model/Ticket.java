...
public class Ticket {
    ...
    TreeMap<Passenger, Double> passengersMap = new TreeMap<>();
    ...
    private String generatePNR() {
        travelDateString=dateString.toString().split("/")[2]+dateString.toString().split("/")[1]
    ...
    public void writeTicket(){
        pnrNum=generatePNR();
        File file=new File("C:\\Users\\user306\\Desktop",pnrNum+".txt");
        try {
            file.createNewFile();
        }
        catch (IOException e) {
